  ...
  return (
    ...
    <section className='flex flex-col items-center justify-center relative p-8 overflow-hidden'>
      ...
      {!repoData ? (
        ...
        <div className='relative flex flex-col gap-8 md:w-3/4 items-center justify-center bg-card border border-brand-primary/20 py-12 px-6 text-text text-center h-100'>
          <Message
